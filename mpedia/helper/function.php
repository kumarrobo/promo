...
session_start();
$licensekey = '7abd384c-4362-42ca-a496-9cc227164912'; // masukan license key
function url_wa()
{
    global $base_url;
    //  return $base_url; // untuk di hosting
    return 'http://192.168.0.3:3000/'; // untuk di local
}
include_once("license.php");
$lvs = new LVS(array());

//check if a license key is valid
// if ($lvs->is_valid_license($licensekey) == false) {
    // redirect('https://license.m-pedia.my.id/invalid.html');
    // die;
// };
// //get single product information

// if ($lvs->get_product_info()->data[0]->serialmask != 'MPWA') {
    // redirect('https://license.m-pedia.my.id/invalid.html');
    // die;
// };
